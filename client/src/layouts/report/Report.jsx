...
import FebruaryReport from './components/FebruaryReport'
import "./Report.css"
import MarchReport from './components/MarchReport'
import AprilaReport from './components/AprilaReport'
import MayReport from './components/MayReport'

function Report() {
  return (
    <DashboardLayout>
      <DashboardNavbar/>
      <div className='tree'><JanuaryReport/></div>
      <div className='tree'><FebruaryReport/></div>
      <div className='tree'><MarchReport/></div>
      <div className='tree'><AprilaReport/></div>
      <div className='tree'><MayReport/></div>
    </DashboardLayout>
  )
}
