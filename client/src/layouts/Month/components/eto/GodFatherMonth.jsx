...
function GodFatherMonth() {
    ...
    const locadData=async ()=>{
        const response=await axios.get("http://localhost:3001/currentmonthgodfathereto");
    ...
    const series= [{
     ...
     const options= {
        ...
        title: {
          text: 'Current Month ETO Of GoFathers',
          floating: true,
          offsetY: 330,
          align: 'center',
          style: {
