...
function GodFatherMonthVop() {
    ...
    const locadData=async ()=>{
        const response=await axios.get("http://localhost:3001/currentmonthgodfathervop");
...
export default GodFatherMonthVop